...
if (player1Details.score > player2Details.score) {
    winner.innerText = `🏆 ${player1Details.name} Wins! 🎉
A fantastic performance and a well-deserved victory! 👏`;
}
else if (player1Details.score < player2Details.score) {
    winner.innerText = `🏆 ${player2Details.name} Wins! 🎉
A fantastic performance and a well-deserved victory! 👏`;
}
else {
    winner.innerText = `🎉 It's a Draw! 🤝
Both players played brilliantly and share the crown! 👑`;
}
